...
function Footer() {
  ...
  return (
    <footer className="mt-16 w-full bg-[#e7e4e0]">
      {/* Subscribe Section */}
      <div className="bg-[#d4a373] py-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 text-white gap-6">
          <div className="text-center md:text-left">
            <h2 className="text-2xl md:text-3xl font-semibold mb-2">Subscribe for Updates</h2>
          ...
          <div className="flex w-full max-w-md mx-auto md:mx-0">
            <input
              ...
              className="px-4 py-3 w-full rounded-l-lg outline-none border border-gray-200 text-gray-300"
            />
            <button className="bg-gray-900 px-6 py-3 rounded-r-lg hover:bg-gray-800 transition font-medium">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="py-12 text-center">
        <h3 className="text-2xl font-semibold text-gray-800 mb-6">Shop Our Instagram</h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 px-6 md:px-12">
          {instaImages.map((img, i) => (
            <div key={i} className="overflow-hidden rounded-lg">
              <img
                src={img}
                alt={`insta-${i}`}
                className="w-full h-32 sm:h-40 object-cover hover:scale-105 transition duration-300"
              />
            </div>
          ))}
        </div>
      ...
      {/* Footer Links */}
      <div className="bg-[#fff8f2] text-gray-900 py-10 px-6 md:px-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-gray-800 font-semibold text-lg mb-4">About</h4>
            <ul className="space-y-2">
              <li>Our Story</li>
              <li>Careers</li>
              <li>Press</li>
          ...
          <div>
            <h4 className="text-gray-800 font-semibold text-lg mb-4">Follow Us</h4>
